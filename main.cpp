...
void update() {
    ...
    // g_frames++; // don't need frames anymore

    static float rotation_angle = 0.0f;
    float rotation_speed = 1.0f;
    rotation_angle += rotation_speed * delta_time; // account for frame speed

    g_position.x = g_radius * cos(rotation_angle);
    g_position.y = g_radius * sin(rotation_angle);
